...
if __name__ == "__main__":
    ...
    if historical_data:
        ...
        tradingEngine = TradingEngine(historical_data["data"]["items"][:starting_index + 1], INTERVAL)
        tradingEngine.check_for_trading_action()
        ...
        for i in range(starting_index + 1, len(historical_data["data"]["items"])):
            ...
            action = tradingEngine.check_for_trading_action()
